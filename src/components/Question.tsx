...
export default function QuestionComponent({ value, width = '75%', img, showAnswer, userAnswer, possibleAnswers, questionIndex, setAnswer, correctAnswer }: Props): JSX.Element {

  return <div>
    <h2 className="text-3xl text-white font-bold mb-10">{questionIndex + 1}. {value}</h2>
    {img && <div className="flex justify-center"><img style={{ width }} className="bg-white" src={img} alt="Space Telescope" /></div>}
